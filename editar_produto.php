...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    move_uploaded_file($imagem, $target_file);
        ...
        $stmt = $pdo->prepare("UPDATE PRODUTOS SET NOME = :nome, DESCRICAO = :descricao, PRECO = :preco, IMAGEM = :imagem, URL_IMAGEM = :url_imagem WHERE id = :id");
...
<body>
    ...
    <form action="editar_produto.php" method="POST" style="max-width: 500px; margin: 0 auto;" enctype="multipart/form-data">
        <div class="form-group">
            <label for="id">Id:</label>
            <input type="text" name="id" id="id" class="form-control" value="<?php echo $produto['id']; ?>" readonly>
        </div>
        <div class="form-group">
            <label for="nome">Nome:</label>
            <input type="text" class="form-control" value="<?php echo $produto['nome']; ?>" name="nome" id="nome" placeholder="Nome">
        </div>
        <div class="form-group">
            <label for="descricao">Descrição:</label>
            <textarea class="form-control" value="<?php echo $produto['descricao']; ?>" name="descricao" id="descricao" required></textarea>
        </div>
        <div class="form-group">
            <label for="preco">Preço:</label>
            <input type="text" class="form-control" value="<?php echo $produto['preco']; ?>" name="preco" id="preco" placeholder="R$0,00" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="url" name="url_imagem" id="url_imagem" class="form-control" value="<?php echo $produto['url_imagem']; ?>" readonly>
        </div>
